...
const getProblemById = async(req,res)=>{
  ...
  try{
    ...
    const getProblem = await Problem.findById(id).select('_id title description difficulty tags visibleTestCases hiddenTestCases startCode constraints referenceSolution');
